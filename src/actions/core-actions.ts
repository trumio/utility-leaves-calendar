...
export const populateLeaves = async (username: string, password: string, set: (state: Partial<CoreStore>) => void, get: () => CoreStore, force: boolean = false) => {
...
export const populateHolidays = async (username: string, password: string, set: (state: Partial<CoreStore>) => void, get: () => CoreStore, force: boolean = false) => {
